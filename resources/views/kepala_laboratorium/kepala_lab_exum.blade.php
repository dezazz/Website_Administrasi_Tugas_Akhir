...
@section('title')
    <title>Kepala Laboratorium - Executive Summary</title>
@endsection
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Daftar Pengajuan Executive Summary</h3>
                </div>
            </div>
        </div>
                    ...
                    <tbody>
                        @foreach ($exum as $item)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('kepala_lab_exum_setujui', $item->nim) }}"
                                        class="btn btn-primary">Setujui</a>
                                    <a href="{{ route('kepala_lab_exum_tolak', $item->nim) }}"
