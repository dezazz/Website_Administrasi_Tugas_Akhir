...
@section('title')
    <title>Admin - Tambahkan Kepala Laboratorium</title>
@endsection
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Tambah Kepala Laboratorium Baru</h3>
                </div>
            </div>
        </div>
                ...
                <div class="card card-outline-secondary">
                    <div class="row align-items-center m-5">
                        <div class="col-md mb-5">
                            <!-- REGISTERATION FORM Kepala Laboratorium -->
                            <form class="form form-horizontal" method="POST" action="{{ route('add_kepala_lab') }}">
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                        <!-- DATA AKUN -->
                                        <h3>1. Data Akun Kepala Laboratorium</h3>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <label for="kode">Bidang Ilmu</label>
                                        </div>
                                        <div class="col-md-8 form-group">
                                        ...
                                        <div class="col-md-8">
                                            <select class="form-control  @error('sex') is-invalid @enderror" id="sex"
                                                name="sex" required value="{{ old('sex') }}" autocomplete="sex">
                                                <option value=""></option>
                                        ...
                                        <!-- END DATA PRIBADI Kepala Laboratorium -->
                                    </div>
                                </div>
                            </form>
                            <!-- END REGISTERATION FORM Kepala Laboratorium -->
                        </div>
                    </div>
                </div>
            </div>
