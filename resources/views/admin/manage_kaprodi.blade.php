...
@section('title')
    <title>Admin - Manajemen Kepala Program Studi</title>
@endsection
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Manajemen User Kepala Program Studi</h3>
                </div>
            </div>
        </div>
                ...
                <div class="card card-outline-secondary">
                    <div class="row align-items-center m-5">
                        <div class="col-md mb-6">
                            <h5>Daftar Akun dan Data Kepala Program Studi</h5></br>
                            <a href="/admin/add_kaprodi" class="btn btn-success btn-sm"><i
                                                ...
                                                <td>
                                                    <center>
                                                        <table>
                                                            <tr>
                                                                <td>
                                                                    <form action="/admin/edit_kaprodi">
                                                                        @csrf
                                                                ...
                                                                <td>
                                                                    <form action="{{ '/admin/delete_kaprodi' }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        <input type="hidden" name="nip"
                                                                            value="{{ $prodi->nip }}">
