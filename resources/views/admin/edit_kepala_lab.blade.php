...
@section('title')
    <title>Admin - Edit Data Kepala Laboratorium</title>
@endsection
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Edit Data Kepala Laboratorium</h3>
                </div>
            </div>
        </div>
                ...
                <div class="card card-outline-secondary">
                    <div class="row align-items-center m-5">
                        <div class="col-md mb-5">
                            <br>
                            <!-- FORM UPDATE DOSEN -->
                            <form class="form form-horizontal" action="{{ route('update_kepala_lab') }}" method="POST">
                                @csrf
                                <input type="hidden" name="old_nip" value="{{ $dosen->nip }}">
                                <input type="hidden" name="old_nidn" value="{{ $dosen->nidn }}">
                                <input type="hidden" name="old_kode" value="{{ $dosen->bidang_ilmu }}">
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-xl-12 col-md-6">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <label for="new_kode">Bidang Ilmu</label>
                                                </div>
                                                <div class="col-md-8 form-group">
                                                    <select class="form-select @error('new_kode') is-invalid @enderror"
                                                        id="basicSelect" name="new_kode">
                                                        @foreach ($bidang_ilmu as $item)
