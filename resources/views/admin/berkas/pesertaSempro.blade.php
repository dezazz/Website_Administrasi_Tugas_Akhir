                ...
                <center>
                    ...
                    <table width="700" class="text-right">
                        <tr>
                            ...
                            <td width="445">:
                                {{ Carbon::parse($query[0]->tanggal_sempro)->translatedFormat('l / d F Y') }}</td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>PUKUL</td>
                            <td width="445">:
                                {{ Carbon::createFromFormat('H:i:s', $query[0]->waktu)->format('H:i') }}
                                WIB</td>
                        </tr>
                        <tr>
                            <td></td>
                        ...
                        @for ($i = 0; $i <= count($query) - 1; $i += 2)
                            <tr>
                                ...
                                <td width="50" class="text5">
                                    <font size="2">{{ $query[$i]->nama }} {{ $query[$i]->nim }}</font>
                                </td>
