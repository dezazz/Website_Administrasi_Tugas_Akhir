...
@section('title')
    <title>Sekretaris Prodi - Daftar Jadwal Seminar Hasil</title>
@endsection
            ...
            @foreach ($tanggal as $dt)
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="/sekretaris_prodi/undangan_daftar_peserta/undangan_seminar_hasil/{{ $dt->tanggal_semhas }}"
                            target="blank"><button type="button" class="btn btn-success"><i
                                    class="bi bi-printer-fill"></i>&nbsp;Cetak Undangan</button></a>
                        &nbsp;&nbsp;
                        <a href="/sekretaris_prodi/undangan_daftar_peserta/peserta_seminar_hasil/{{ $dt->tanggal_semhas }}"
                            target="blank"><button type="button" class="btn btn-success"><i
