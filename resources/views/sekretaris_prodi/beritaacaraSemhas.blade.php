...
@section('title')
    <title>Sekretaris Prodi - Berita Acara Seminar Hasil</title>
@endsection
            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        ...
                        <p class="text-subtitle text-muted">Daftar acara berita acara seminar hasil mahasiswa-mahasiswa</p>
                    </div>
                </div>
            </div>
                                    ...
                                    <tbody>
                                        ...
                                        @for ($i = 0; $i <= count($query) - 1; $i += 2)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/sekretaris_prodi/beritaacara/semhas/{{ $query[$i]->nim }}"><button
