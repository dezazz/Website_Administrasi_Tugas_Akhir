                ...
                <center>
                    <table width="625">
                        ...
                        <table width="625">
                            ...
                            <tr>
                                <td class="text">
                                    <font size="3"><b>PRA SIDANG MEJA HIJAU</b></font>
                                </td>
                            </tr>
                        </table>
                    </table><br>
                    ...
                    <div class="padsss">
                        <table width="625" border="1" class="skrt">
                            ...
                            @if ($bimbingan_sidang->count() > 0)
                                @foreach ($bimbingan_sidang as $bimbingan)
                                    <tr>
                                ...
                                @endforeach
                                @if ($bimbingan_sidang->count() < 5)
                                    @for ($i = 0; $i < 5 - $bimbingan_sidang->count(); $i++)
                                        <tr>
                                            <td width="50" class="ungu">{{ $bimbingan_sidang->count() + $i + 1 }}
                                            </td>
