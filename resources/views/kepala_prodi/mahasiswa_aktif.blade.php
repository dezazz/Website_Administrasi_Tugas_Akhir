...
@section('title')
    <title>Kepala Prodi - Mahasiswa Aktif</title>
@endsection
...
@section('content')
    <div id="main">
        ...
        <div class="page-heading">
            ...
            <div class="row">
                <div class="col-xl-8">
                    <form action="/kepala_prodi/menu_mahasiswa/mahasiswa_aktif/search">
                        @csrf
                        <div class="row">
                            <div class="col-xl-11">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($mahasiswas as $mahasiswa)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/kepala_prodi/lembar_kendali/{{ $mahasiswa->nim }}"
