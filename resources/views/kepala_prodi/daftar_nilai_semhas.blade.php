                    ...
                    <div class="row align-items-center m-5">
                        <div class="col-md mb-6">
                            <div class="table-responsive">
                                {{-- alert success_add_nilai_semhas --}}
                                @if (session('success_add_nilai_semhas'))
                                    <div class="alert alert-success alert-dismissible show fade">
                                        <i class="bi bi-check-circle"></i> {{ session('success_add_nilai_semhas') }}
                                        <button type="button" class="btn-close" data-bs-dismiss="alert"
                                            aria-label="Close"></button>
                                    </div>
                                @endif
                                {{-- alert success_update_nilai_semhas --}}
                                @if (session('success_upd_nilai_semhas'))
                                    <div class="alert alert-success alert-dismissible show fade">
                                        <i class="bi bi-check-circle"></i> {{ session('success_upd_nilai_semhas') }}
                                        <button type="button" class="btn-close" data-bs-dismiss="alert"
                                            aria-label="Close"></button>
                                    </div>
                                @endif
                                {{-- success_delete_nilai_semhas --}}
                                @if (session('success_del_nilai_semhas'))
                                    <div class="alert alert-warning alert-dismissible show fade">
                                        <i class="bi bi-check-circle"></i> {{ session('success_del_nilai_semhas') }}
                                        <button type="button" class="btn-close" data-bs-dismiss="alert"
                                            aria-label="Close"></button>
                                    </div>
                                @endif
                                                ...
                                                <td>
                                                    <center>
                                                        <table>
                                                            <tr>
                                                                @if ($mahasiswas[$i]->nama != null)
                                                                    <td>
                                                                        <form
                                                                            action="{{ route('edit_nilai_semhas_kaprodi') }}">
                                                                            @csrf
                                                                    ...
                                                                    <td>
                                                                        <form
                                                                            action="{{ route('delete_nilai_semhas_kaprodi') }}"
                                                                            method="POST">
                                                                            @csrf
                                                                            <input type="hidden" name="nim"
                                                                                value="{{ $mahasiswas[$i]->nim }}">
                                                        ...
                                                        @else
                                                            <tr>
                                                                <td>
                                                                    <form action="{{ route('add_nilai_semhas_kaprodi') }}"
                                                                        method="GET">
                                                                        @csrf
                                                                        <input type="hidden" name="nim"
                                                                            value="{{ $mahasiswas[$i]->nim }}">
