...
@section('title')
    <title>Kepala Prodi - Lembar Kendali</title>
@endsection
            ...
            <div class="col-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <hr>
                        <a href="/kepala_prodi/lembar_kendali_sempro/{{ $nim }}" class="btn btn-primary"><i
            ...
            <div class="col-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <hr>
                        <a href="/kepala_prodi/lembar_kendali_semhas/{{ $nim }}" class="btn btn-primary"><i
                                class="bi bi-printer-fill"></i> Cetak </a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <hr>
                        <a href="/kepala_prodi/lembar_kendali_sidang/{{ $nim }}" class="btn btn-primary"><i
                                class="bi bi-printer-fill"></i> Cetak </a>
                    </div>
                </div>
            </div>
