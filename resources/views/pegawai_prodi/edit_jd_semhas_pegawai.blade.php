...
@section('title')
    <title>Pegawai Prodi - Edit Jadwal Seminar Hasil</title>
@endsection
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Edit Jadwal Seminar Hasil</h3>
                    <p class="text-subtitle text-muted">Silahkan edit jadwal seminar hasil mahasiswa</p>
                </div>
            </div>
        </div>
                    ...
                    <div class="row align-items-center m-5">
                        <div class="col-xl-12 mb-5">
                            ...
                            <form class="form form-horizontal" method="post"
                                action="{{ route('store_new_jd_semhas_pegawai') }}">
                                @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="time" class="form-control @error('waktu') is-invalid @enderror"
                                                id="waktu" name="waktu" required value="{{ $jadwal->waktu }}">
                                            @error('waktu')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
