...
@section('title')
    <title>Pegawai Prodi - Atur Jadwal Seminar Proposal</title>
@endsection
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">Silahkan atur Jadwal Seminar Proposal melalui form berikut.</p>
                </div>
            </div>
        </div>
                    ...
                    <div class="row align-items-center m-5">
                        <div class="col-xl-12 mb-5">
                            ...
                            <form class="form form-horizontal" method="post"
                                action="{{ route('store_jd_sempro_pegawai') }}">
                                @csrf
